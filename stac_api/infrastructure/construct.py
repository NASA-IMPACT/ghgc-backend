...
from .config import stac_settings
    ...
    def __init__(
        ...
        **kwargs,
        ...
        lambda_function = aws_lambda.Function(
            ...
            memory_size=stac_settings.memory,
            timeout=Duration.seconds(stac_settings.timeout),
            environment={
                "DB_MIN_CONN_SIZE": "0",
                "DB_MAX_CONN_SIZE": "1",
                **{k.upper(): v for k, v in stac_settings.env.items()},
            },
        ...
        lambda_function.add_environment(
            "STAC_PGSTAC_SECRET_ARN", database.pgstac.secret.secret_full_arn
        )
